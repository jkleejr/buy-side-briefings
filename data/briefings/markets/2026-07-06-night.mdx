...
*Night briefing — US equity close wrap, July 7 open forecast, and week-ahead positioning. Educational analysis only — not investment advice.*
...
- ⚠️ **NVDA's $0.84 Stop Day 2 margin** — the thinnest framework survival of this cycle; IBIT Gate 3 remains unconfirmed; full-size add requires NVDA >$200 simultaneously at July 7 open
...
| **30Y UST** | **~4.985%** | **~flat** | ⚠️ APPROACHING TRIGGER — 1.5bps from 5.00% danger zone; ISM cool prevented breach |
| **DXY** | **~100.62 (est.)** | **~−0.16%** | ⚠️ Approaching 100 breakline from above; continuing to soften on ISM cool + risk-on |
| **BTC** | **~$61,677–$61,900** | **~−$2,000** | 🔴 UTC MIDNIGHT CLOSE AT RISK — intraday below $62K floor; Strategy $216M sale disclosed |
| **ETH** | **~$1,737** | **~−1.5% (24h)** | ⚠️ Correlated decline with BTC reversal |
...
| *NVDA* | **~$195.84** | **+0.37%** | ⚠️ STOP DAY 2 SURVIVED ($0.84 MARGIN) — Stop Day 1 isolated; half-size hold maintained |
...
|---|---|---|---|
| *NVDA* | **~$195.84** | **+0.37%** | ⚠️ STOP DAY 2 SURVIVED ($0.84 margin) — Stop Day 1 isolated; full-size add gate July 7 open at 9:25 AM ET (NVDA >$200 + SPX >7,460 + VIX <17 simultaneously) |
...
| *AAPL* | **~$274** | **+1.31%** | ⚠️ Participated in Nasdaq rally but China/CXMT/YMTC overhang persists; avoid adding |
...
| *TSLA* | **~$397 (est.)** | **~+1% (est.)** | ⚠️ Recovering with market but no new catalyst since delivery sell-the-news; Q2 earnings ~July 22 |
| *AMD* | **~$517 (est.)** | **~+2% (est.)** | ⚠️ Nasdaq tailwind; SK Hynix Stop Day 2 confirms HBM/DRAM distribution ongoing; no standalone catalyst |
| *TSM* | **~$460 (est.)** | **~+1% (est.)** | ⚠️ SK Hynix ADR July 10 listing = HBM4 clearing event; monitor |
...
- **30Y ~4.985%** — trigger above 5.00% ⚠️ **APPROACHING DANGER ZONE — 1.5bps BUFFER.** [ISM Services at 54.0% (cool from 54.5%) prevented the hot-print scenario that would have pushed the 30Y through 5.00%](https://www.prnewswire.com/news-releases/services-pmi-at-54-june-2026-ism-services-pmi-report-302817275.html). The 30Y is the most precarious regime indicator entering FOMC minutes July 8 — minutes written from the June 17 committee's data backdrop predate the 57K NFP print and will likely read hawkish relative to current market pricing.
