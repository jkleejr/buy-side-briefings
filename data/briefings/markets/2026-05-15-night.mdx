...
**Single thing to watch first:** the **30Y yield at 5.13%**. If it pushes through 5.20% on Monday, no risk asset gets a meaningful bounce. If it backs off to <5.05%, the bounce-case opens.
...
A smart bear of *my* Step-Aside call would say: today was Friday-options-expiry mechanics plus a delta-hedging flush, not the start of a regime change. Friday OPEX often produces sharp moves that reverse Monday. VIX at 18.43 is elevated but nowhere near "panic" (>25). If Asia stabilizes Sunday and tech catches a quality bid Monday morning, today's drawdown could be a textbook buy-the-dip — and stepping aside means missing it.

The oil spike could also be a one-off geopolitical headline already in the price, rather than persistent inflation pressure. The fact that **DXY barely moved (-0.01%) argues against a real macro break** — if Friday were a genuine risk-off event, the dollar would be ripping. The signal-to-noise from a single Friday close is genuinely low.

**If SPX reclaims 7,460 by midday Monday with VIX printing <17, Step Aside is wrong** and the right adjustment is back to selective BUY by Tuesday's open.
