...
- **[10Y UST ~4.54% (est. –4 bps from 4.58%)](https://tradingeconomics.com/united-states/government-bond-yield)** — marginal easing; 30Y est. ~5.06%, above 5.00% for 4th consecutive session; rates did not respond meaningfully to the constructive equity session
