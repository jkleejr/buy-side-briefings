...
| | Level | Change | Note |
|---|---|---|---|
| S&P 500 futures (ES) | ~7,425 | +0.41% | 35 POINTS BELOW 7,460 FLOOR — regime-clearing close would be a constructive signal today |
...
- **DXY 100.04** — trigger above 100 **MARGINALLY RE-BREACHED** (+0.18% from 99.86 June 11 close; re-crossed above 100 — second breach in four sessions; residual inflation expectations are offsetting the oil-negative dollar effect; a confirmed Iran deal signing + continued Brent decline this weekend could send DXY toward 98.5–99)
- **SPX 7,425 pre-market** — trigger below 7,460 **BREACHED — 35 POINTS BELOW FLOOR** (improving: was 65 pts below on June 11 close, pre-market narrows it to 35 pts; a session close above 7,460 today would be the first regime-clearing print since June 5 and would signal the floor recovery is real)
