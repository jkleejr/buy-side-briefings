...
## 📊 Snapshot — Friday Pre-Market (~9:00 AM ET)
...
## 🌅 Friday Tape View — Pre-Memorial Day
...
- **VIX 17.58** — trigger above 18 ⚠️ **EASING** (from 17.80 Thursday pre-open; current range 16.60-17.87; needs two closes below 16.0 to neutralize the trigger; pre-holiday compression may artificially suppress this reading)
