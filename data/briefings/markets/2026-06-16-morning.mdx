...
| 10Y UST | **4.48%** | **+6 bps** | ⚠️ POST-DEAL BOND RALLY FADING — up from 4.42% June 15 close; first yield rise since June 11; FOMC pre-meeting caution |
| 30Y UST | **~4.91% est.** | **~+6 bps est.** | ⚠️ BUFFER NARROWING — estimated up from ~4.85% June 15 est.; ~9 bps from 5.00% regime trigger; Warsh FOMC is the pivotal gate |
...
| *XLE* | ~$54 est. | ⚠️ Day 3 of structural repricing — WTI ~$80, Brent ~$83; [active short $54–57; IG International June 16 confirms oil continues to fall on Iran deal](https://www.ig.com/en/news-and-trade-ideas/oil-falls-on-us-iran-deal-260616) |
...
- **30Y ~4.91% est.** — trigger above 5.00% ✅ **CLEARED BUT ⚠️ BUFFER NARROWING** (10Y rising 6 bps to 4.48% June 16 morning implies 30Y similarly higher from ~4.85%; buffer to 5.00% trigger has narrowed from ~15 bps to ~9 bps; FOMC is the key risk — if today's bond auction or pre-FOMC positioning pushes 30Y to 4.97–5.00% before Warsh even speaks, the regime trigger is at risk before tomorrow's presser)
