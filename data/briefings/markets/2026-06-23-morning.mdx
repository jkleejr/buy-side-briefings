...
- **VIX 17.28 (+2.98%)** — trigger above 17 **BREACHED** — add-gates suspended across all longs; [Nikkei -0.6%, DAX -1.32% confirm global tech sell-off extending the VIX bid](https://www.investtech.com/main/market.php?MarketID=992&product=38); watch for VIX below 17 on any June 23 constructive risk-on trade

- **30Y ~4.93%** — trigger above 5.00% **7-BPS BUFFER** — [May PCE on June 25 (Wells Fargo est. 4.1% YoY, 0.3% MoM core)](https://www.kiplinger.com/investing/economy/this-weeks-economic-calendar) is the binary; hot print pushes 30Y through 5.00% on the same session, triggering BEARISH upgrade immediately; Brent -3.3% is the disinflation offset

- **DXY 101.02 (+0.17%)** — trigger above 100 **BREACHED — 102 BPS ABOVE GATE** — [dollar held bid by Warsh hawkish posture; widened from 100.80 Asian session to 101.02 US close](https://finance.yahoo.com/quote/DX-Y.NYB/); PCE June 25 downside miss is the primary DXY catalyst for gate restoration

- **SPX 7,472.79** — trigger below 7,460 **12-PT BUFFER — CRITICAL WATCH** — [ES futures -0.2% pre-open imply open near 7,458](https://finance.yahoo.com/markets/stocks/articles/us-stock-market-today-p-081239995.html); gap below 7,460 converts STEP_ASIDE to BEARISH immediately without waiting for June 24 catalysts; this is the most important intraday level
...
- **BTC Stop $62,325** — trigger below $63,500 **STOP ALERT — $1,175 BELOW STOP** — [June 23 UTC close (midnight UTC = 8pm ET) is the gate](https://www.coindesk.com/price/bitcoin); if close below $63,500 full exit at market; BTC needs +1.9% recovery by 8pm ET to preserve position
