...
## 📊 Snapshot — Thursday Pre-Market (~9:30 AM ET)
...
- **VIX 17.80** — trigger above 18 ⚠️ **RISING** (up from Wednesday's 16.86 close; moving wrong direction; one close above 18 → Step Aside review)
