...
|---|---|---|---|
| S&P 500 | **~7,365** | **-1.44%** | ✖️ BELOW 7,460 REGIME FLOOR — BEARISH trigger fired |
...
| VIX | **19.49** | **+12.79%** | ⚠️ Approaching 20 panic threshold |
...
| **BTC** | **$62,472** | **-2.3%** | ⚠️ Day 1 stop CONFIRMED — $1,028 below $63,500 (Crypto.com close) |
| **ETH** | **~$1,654** | **-6%** | Following BTC lower |
| *MU* | **~$1,075** | **-11.4%** | ⚠️ Pre-earnings -11%; SK Hynix/Samsung HBM4E contagion; earnings June 24 AH |
...
|---|---|---|---|
| *NVDA* | **~$202** | **-3.2%** | ⚠️ Annual Meeting override add executed (per morning brief rule); Annual Meeting TOMORROW 9 AM PT; stop $195 unchanged |
| *MU* | **~$1,075** | **-11.4%** | ⚠️ Pre-earnings flush; KOSPI/Samsung HBM4E contagion; Q3 earnings tomorrow after close; stop $990 |
| *GOOGL* | **~$341.50** | **-10%** | ❌ Cumulative -16.5% over 2 sessions; short/puts active; next catalyst mid-July Q2 earnings |
| *TSM* | **~$443** | **-5.2%** | ⚠️ KOSPI contagion; ADR hit 52-wk high intraday then reversed; hold through MU read-through |
| *AVGO* | **~$381** | **-2.8%** | ⚠️ AI semis under pressure; no add |
| *AMZN* | **est. -4%** | **est.** | ⚠️ Sympathy AI software sell-off |
| *META* | **est. -4%** | **est.** | ⚠️ AI talent overhang; hold, no add |
| *AAPL* | **~$298 est.** | **est.** | ✅ Relative outperformer; defensive mega-cap |
| *PLTR* | **est. -4%** | **est.** | ⚠️ No position |
| *SK Hynix* | **~₩2,569K est.** | **-12% est.** | ⚠️ Stop ₩2,540K intact; core long hold; June 25 KST = MU read-through |
| *XLE* | **✅ SHORT** | **—** | Brent $77.42 confirms thesis |
| *BTC* | **~$62,250** | **-2.8%** | ⚠️ Day 1 stop confirmed; 50% reduction executed; Day 2 June 24 UTC = full exit gate |
| *ETH* | **~$1,654** | **-6%** | Following BTC; no standalone position |

## ⚠️ Regime Risk Indicators

- **VIX 19.49 (+12.79%)** — trigger above 17 ✖️ **HARD BREACH** — two consecutive sessions above 17 gate; approaching 20 panic threshold; [no new longs permitted](https://finance.yahoo.com/quote/%5EVIX/); watch for VIX spike-and-fade to 22–25 as capitulation signal

- **30Y ~4.94%** — trigger above 5.00% ⚠️ **6-BPS BUFFER** — stable for now; [PCE + GDP final on June 25 at 8:30 AM ET is the binary](https://www.bea.gov/news/schedule); hot PCE pushes through 5.00% on the same session; size exits before Thursday open

- **DXY 101.38 (+0.36%)** — trigger above 100 ✖️ **HARD BREACH (138 BPS ABOVE GATE)** — widening each session; [Warsh hawkish posture intact; PCE undershoot June 25 is the sole DXY catalyst](https://finance.yahoo.com/quote/DX-Y.NYB/); no gate clearance expected before then

- **SPX ~7,365** — trigger below 7,460 ✖️ **BEARISH TRIGGER FIRED** — [95 pts below floor; morning brief's explicit conversion rule activated](https://www.thestreet.com/stock-market-today/stock-market-today-dow-jones-sp-500-nasdaq-updates-june-23-2026); 7,300 is next support; no intermediate level

- **BTC $62,472 (UTC close)** — trigger below $63,500 ✖️ **DAY 1 STOP CONFIRMED** — [Crypto.com API: O $63,962 / H $64,221 / L $61,863 / C $62,472](https://fortune.com/article/price-of-bitcoin-06-23-2026/); $1,028 below stop; 50% reduction executed; Day 2 UTC midnight June 24 = full exit gate
...
**Regime summary:** Five-indicator check: VIX ✖️, DXY ✖️, SPX ✖️, BTC ✖️, Brent ✅. Four of five primary regime indicators in breach state. This is the most defensively constrained setup since the May 15 "four triggers fired" session. The framework calls for: full defensive posture, no new index longs, hedges active, June 24 dual catalyst as the sole upgrade pathway.
