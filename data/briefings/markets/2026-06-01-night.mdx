...
- **30Y Yield ~5.01%** — trigger above 5.05% ⚠️ **BREACHED 5.00% INTRADAY; DAY-2 CONFIRMATION FAILED** (re-broke 5.00% intraday on Iran suspension headline before settling near 5.01%; the two-session sub-5.0% confirmation sequence that was Day 1 on May 29 has been reset; Day-1 must be re-established)
