...
export const metadata = {
  title: "The Black Swan Report — Buy-Side Briefings",
  description:
    "Taleb's Black Swan framework, fact-checked and applied: what the book actually says, what its critics say back, how July 2026's shocks grade against it, and where genuinely unmodeled risk sits today.",
};

export const revalidate = 3600;

export default function BlackSwanPage() {
  const thesis = getThesis("black-swan");
  if (!thesis) {
    return (
  ...
  return (
    <div className="mx-auto max-w-3xl space-y-1">
      ...
      <Panel code="REPORT" title="The Black Swan Report">
      ...
      <p className="px-1 pt-2 font-mono text-[10px] leading-snug text-[var(--dim)]">
        ...
        . For today&apos;s tactical read, see the{" "}
